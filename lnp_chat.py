...
class LNPChat:
    ...
    translator: Optional[Translator] = field(init=False, default=None)
        ...
        try:
            ...
            if self.translate:
                if Translator:
                    ...
                    print("\n⚠️ 경고: 'googletrans' 라이브러리를 찾을 수 없어 번역 기능이 비활성화됩니다.")
    ...
    def ask(self, query: str, topk: Optional[int] = None) -> Dict[str, Any]:
        ...
        if self.translator:
            try:
                ...
                translated = asyncio.run(self.translator.translate(query, dest='en'))
                query_for_search = translated.text
