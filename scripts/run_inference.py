...
Options:
    ...
    # 자동 언어 감지 모드
python scripts/run_inference.py --input "C:\python\github\AI-summary\ami_outputs\EN2001a.Headset-0\transcript.txt"

# 강제로 KoBART 사용
python scripts/run_inference.py --input "C:\path\to\transcript.txt" --force-model "gogamza/kobart-base-v2"
""" 
...
# 기본 모델 매핑
MODEL_MAP = {
    "ko": "C:\\python\\github\\AI-summary\\artifacts\\kobart_ft\\checkpoint-42",  # fine-tuned KoBART
